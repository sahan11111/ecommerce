...
function VendorRegister(props){
    ...
    const buttonEnable=(registerFormData.first_name !=='')&&(registerFormData.last_name !=='')&&(registerFormData.username !=='')&&(registerFormData.password !=='')&&(registerFormData.email !=='')&&(registerFormData.mobile !=='')&&(registerFormData.address !=='')
    return(
                ...
                <div className='card'>
                    ...
                    <form>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea type="text" name="address" value={registerFormData.address} onChange={inputHandler} className="form-control" id='address'></textarea>
                        </div>                           
                        <div className="mb-3">
