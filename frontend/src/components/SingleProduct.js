        ...
        <div className="col-12 col-md-3 mb-4">
            <div className="card shadow h-100 d-flex flex-column">
                ...
                <div className='card-footer'>
                    ...
                    {
                        (userContext && productInWishlist) &&
                        <button onClick={saveInWishList} title='Add to Wishlist' className='btn btn-danger btn-sm ms-1 disabled'>
                            <i className="fa fa-heart "></i>
                        </button>
                    }
                    {
                    ...
                    <small className='text-muted'>Downloads: {props.product.downloads}</small>
                </div>
            </div>
        </div>
    )
